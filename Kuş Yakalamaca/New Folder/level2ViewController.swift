...
class level2ViewController: UIViewController {
    ...
    @objc func countDown(){
        ...
        if counter == 0 {
            ...
            if self.score >= 60 {
                let level3 = UIAlertAction(title: "Next Level", style: .default) { _ in
                    self.performSegue(withIdentifier: "level3", sender: self)
                }
    ...
    @IBAction func pauseButtonClixked(_ sender: Any) {
        timer.invalidate()
        hideTimer.invalidate()
