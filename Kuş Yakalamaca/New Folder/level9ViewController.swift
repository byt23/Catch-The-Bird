    ...
    override func viewDidLoad() {
        ...
        @objc func countDown(){
            ...
            if counter == 0 {
                ...
                if self.score >= 60 {
                    let level10 = UIAlertAction(title: "Next Level", style: .default) { _ in
                        self.performSegue(withIdentifier: "level10", sender: self)
                    }
                    alert.addAction(level10)
                }
                ...
                let mainMenuButton = UIAlertAction(title: "Main Menu", style: .cancel) { _ in
                    self.performSegue(withIdentifier: "main9", sender: self)
                }
