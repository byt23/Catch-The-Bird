        ...
        @objc func countDown(){
            ...
            if counter == 0 {
                ...
                if self.score >= 100 {
                    ...
                    let missingPoints = 100 - self.score
                        alertMessage = """
                    You need at least 100 points to reach the next level.
                ...
                if self.score >= 100 {
                    let lastDance = UIAlertAction(title: "Next Level", style: .default) { _ in
                        self.performSegue(withIdentifier: "lastDance", sender: self)
                        }
                    alert.addAction(lastDance)
                    }
                ...
                let mainMenuButton = UIAlertAction(title: "Main Menu", style: .cancel) { _ in
                    self.performSegue(withIdentifier: "main12", sender: self)
                    }
