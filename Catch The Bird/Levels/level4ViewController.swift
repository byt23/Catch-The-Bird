...
class level4ViewController: UIViewController {
    ...
    hideTimer = Timer.scheduledTimer(timeInterval: 0.62, target: self, selector: #selector(hideBird), userInfo: nil, repeats: true)
        ...
        @objc func countDown(){
            ...
            if counter == 0 {
                ...
                if self.score >= 60 {
                    ...
                    if unlockedLevel < 5{
                        UserDefaults.standard.set(5, forKey: "unlockedLevel")
                    }
                }
                ...
                let replayButton = UIAlertAction(title: "Try Again", style: .default) { _ in
                    ...
                    self.hideTimer = Timer.scheduledTimer(timeInterval: 0.62, target: self, selector: #selector(self.hideBird), userInfo: nil, repeats: true)
                    }
