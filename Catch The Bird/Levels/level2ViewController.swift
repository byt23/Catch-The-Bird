...
class level2ViewController: UIViewController {
    ...
    hideTimer = Timer.scheduledTimer(timeInterval: 0.64, target: self, selector: #selector(hideBird), userInfo: nil, repeats: true)
    ...
    @objc func countDown(){
        ...
        if counter == 0 {
            ...
            if self.score >= 40 {
                ...
                let missingPoints = 40 - self.score
                alertMessage = """
                You need at least 40 points to reach the next level.
            ...
            let replayButton = UIAlertAction(title: "Try Again", style: .default) { _ in
                ...
                self.hideTimer = Timer.scheduledTimer(timeInterval: 0.64, target: self, selector: #selector(self.hideBird), userInfo: nil, repeats: true)
            }
