    ...
    @objc func countDown(){
        ...
        if counter == 0 {
            ...
            if self.score >= 70 {
                ...
                if unlockedLevel < 7 {
                    UserDefaults.standard.set(7, forKey: "unlockedLevel")
                }
            }
            ...
            if self.score >= 70 {
                ...
                let missingPoints = 70 - self.score
                    alertMessage = """
                You need at least 70 points to reach the next level.
            ...
            if self.score >= 70 {
                let level7 = UIAlertAction(title: "Next Level", style: .default) { _ in
                    self.performSegue(withIdentifier: "level7", sender: self)
                    }
                alert.addAction(level7)
                }
            ...
            let mainMenuButton = UIAlertAction(title: "Main Menu", style: .cancel) { _ in
                self.performSegue(withIdentifier: "main6", sender: self)
                }
