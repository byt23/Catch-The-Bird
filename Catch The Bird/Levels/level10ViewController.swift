...
class level10ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        hideTimer = Timer.scheduledTimer(timeInterval: 0.56, target: self, selector: #selector(hideBird), userInfo: nil, repeats: true)
        ...
        @objc func countDown(){
            ...
            if counter == 0 {
                ...
                if self.score >= 90 {
                    ...
                    if unlockedLevel < 11 {
                        UserDefaults.standard.set(11, forKey: "unlockedLevel")
                    }
                }
                ...
                if self.score >= 90 {
                    ...
                    let missingPoints = 90 - self.score
                    alertMessage = """
                    You need at least 90 points to reach the next level.
                ...
                let replayButton = UIAlertAction(title: "Try Again", style: .default) { _ in
                    ...
                    self.hideTimer = Timer.scheduledTimer(timeInterval: 0.56, target: self, selector: #selector(self.hideBird), userInfo: nil, repeats: true)
                }
