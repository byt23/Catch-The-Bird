...
class level9ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        hideTimer = Timer.scheduledTimer(timeInterval: 0.57, target: self, selector: #selector(hideBird), userInfo: nil, repeats: true)
        ...
        @objc func countDown(){
            ...
            if counter == 0 {
                ...
                if self.score >= 85 {
                    ...
                    if unlockedLevel < 10 {
                        UserDefaults.standard.set(10, forKey: "unlockedLevel")
                    }
                }
                ...
                if self.score >= 85 {
                    ...
                    let missingPoints = 85 - self.score
                    alertMessage = """
                    You need at least 85 points to reach the next level.
                ...
                let replayButton = UIAlertAction(title: "Try Again", style: .default) { _ in
                    ...
                    self.hideTimer = Timer.scheduledTimer(timeInterval: 0.57, target: self, selector: #selector(self.hideBird), userInfo: nil, repeats: true)
                }
